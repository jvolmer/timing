...
mod tests {
    ...
    impl ListWithNames<NamedStruct> for ListWithNamesStruct {
        fn items(&self) -> std::slice::Iter<NamedStruct> {
            self.items.iter()
        }
    }
    ...
    fn it_finds_one_project() {
        let list = ListWithNamesStruct {
            items: vec![
                NamedStruct {
                    name: "Old Project X".to_string(),
                },
                NamedStruct {
                    name: "New Project Y".to_string(),
                },
            ],
        };
    ...
    fn errors_when_no_project_is_found() {
        let list = ListWithNamesStruct { items: vec![] };
    ...
    fn errors_when_more_than_one_project_is_found() {
        let list = ListWithNamesStruct {
            items: vec![
                ...
                NamedStruct {
                    name: "Another new Project Z".to_string(),
                },
            ],
        };
